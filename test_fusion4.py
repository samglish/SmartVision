...
# ------------------------------------------------------------------
print("\n[2/4] Chargement de YOLOv8m-oiv7 (plus gros que le 's', meilleure généralisation)...")
modele_yolo = YOLO("yolov8m-oiv7.pt")
print("✅ YOLO chargé")
...
priorite_objets = {
    ...
    "Laptop": ("Ordinateur", 2),
    "Land vehicle": ("Véhicule", 6),
    "Vehicle": ("Véhicule", 6),  # filet de sécurité pour véhicules atypiques (tricycles, etc.)
}

SEUIL_YOLO = 0.20  # abaissé pour mieux capter les objets petits/loin
...
priorite_surfaces = {
    ...
    6: ("Route", 5),         # road — zone de circulation, vigilance
    11: ("Trottoir", 1),     # sidewalk — zone normalement sûre
    21: ("Eau", 6),          # water
    26: ("Eau", 6),          # sea
    60: ("Eau", 6),          # river
    109: ("Eau", 6),         # swimming pool
    128: ("Eau", 6),         # lake
}
